...
class MobileRegister extends StatefulWidget {
  const MobileRegister({Key? key, required this.theInitialModel, required this.close}) : super(key: key);
...
class _MobileRegisterState extends State<MobileRegister> {
  ...
  Widget build(BuildContext context) {
    ...
    (MediaQuery.of(context).viewInsets.bottom != 0 && phoneController.text.toString().isNotEmpty) ? validatePhone() : print('ddd');
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(
                        ...
                        child: CustomText(
                            text: "registerPhoneData".tr().toString(),
                    ...
                    SizedBox(
                        width: SizeDataConstant.customWidth(context, 1.1),
                        child: CustomText(
                            text: "registerPhoneDataBottom".tr().toString(),
                            style: TextStyleConstant.optionalText(context, widget.theInitialModel!.data!.account!.mobileAppColors!))),
                    SizedBox(
                        width: SizeDataConstant.customWidth(context, 1.1),
                        child: CustomText(
